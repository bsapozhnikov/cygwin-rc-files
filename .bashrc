...
#export PATH=/cygdrive/c/cygdrive64/bin/:$PATH
export PATH=/c/cygdrive64/bin/:$PATH
...
alias mongodump='/c/Program\ Files/MongoDB/Server/3.2/bin/mongodump.exe'
alias mongorestore='/c/Program\ Files/MongoDB/Server/3.2/bin/mongorestore.exe'
